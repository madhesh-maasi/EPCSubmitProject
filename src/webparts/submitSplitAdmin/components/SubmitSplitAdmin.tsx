...
> {
  ...
  public async componentDidMount() {
    ...
    if (this.state.IsCreateMode) {
      ...
      const SplitAdminDetails: PEPI_SplitAdmin =
        await this.listSplitAdminItemService.getItemUsingCAML(
          this.props.ItemID,
          [],
          undefined,
          Enums.ItemResultType.PEPI_SplitAdmin
        );
      this.setState({
        IsLoading: false,
  ...
  private async onSave(): Promise<void> {
    ...
    if (this.state.IsCreateMode) {
      ...
      await this.listSplitAdminItemService.updateItem(
          ...
          <div className={styles.container}>
            ...
            <div className={styles.row}>
              <div className={styles.lblTopText}>
                ...
                <div className={styles.divCompetency}>
                  <Label>
                    ...
                    Reviewee’s name in the box below and click{" "}
                    <b>Get Reviews</b> to retrieve all associated reviews.
                    Locate the ID number of the review you would like to split
                    and enter it in the box labeled <b>Source Review ID</b>.
                    Complete the <b>Hours to Review</b> and{" "}
                    <b>Title of new Split Review</b>, then click{" "}
                    <b>Create Split Review</b>.
                  </Label>
                </div>
                <hr className={styles.hr}></hr>
              </div>
              ...
              <div className={styles.row}>
                ...
                {this.state.IsCreateMode && (
                  <div className={styles.btnReviewIDs}>
                    <PrimaryButton
