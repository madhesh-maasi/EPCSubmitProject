...
export default class SeniorAssociate extends React.Component<
  IAnalyticsProps,
  IAnalyticsState
> {
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Asks questions to gather relevant information and data and uses
                it to inform the development of a fact-based, team POV.
              </td>
            ...
            <tr>
              <td>
                ...
                Explains rationale for conflicting points-of-views and/or
                assumptions and can determine what perspectives and assumptions
                are important versus what should be discounted.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Develops storyline messages, using supporting facts and
                analyses, insuring data and figures foot, and formatting and
                branding standards are consistently applied across decks.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Asks probing questions to uncover and analyze data in alignment
                with team's hypotheses. Identifies internal information gaps and
                is able to design research and other external data gathering
                processes.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
            ...
            <tr>
              <td>
                ...
                Conducts accurate and comprehensive analyses, and interprets and
                manages data; Draws accurate and relevant conclusions.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Develops fact-based conclusions based on own analysis,
                assimilating information from an array of relevant resources.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Reseraches and understands context before engaging clients;
                Shares insights with team and is able to prepare required
                materials to demonstrate preparedness to clients.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Prioritizes and manages own activities and tasks in alignment
                with defined workplans considering review schedules; Flexes
                priorities to accommodate project ambiguity and fluidity.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Engages in competent conversations regarding client's business
                issues and team challenges, adapts to changing work situations,
                juggling priorities and persevering on issue resolution, despite
                obstacles.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Participates in and takes initiative coordinating activities
                that build the PEPI team and its capabilities; Leverages PEPI
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Participates in PEPI training and development activities as
                scheduled.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Leverages client team member relationships to drive work
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Cultivates project relationships (PEPI, Big A&M, Private Equity
                and Portfolio Companies) into longer-term business relationships
                as a result of dependable, consistent, accurate, and timely
                work.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
            ...
            <tr>
              <td>
                ...
                Participates in selling and engagement efforts by providing
                proposal content and developing portions of pitch decks.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                communication styles, and adapts accordingly to contribute to
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Considers others' preferred communication and learning styles,
                as well as own and others' emotional states and unique
                environmental circumstances before interacting with others.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Aligns personal performance to what the situation demands;
                understands personal competence, motivations, and commitment
                level and how this impacts personal performance in a given
                situation.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
            ...
            <tr>
              <td>
                ...
                Seeks to find common ground and achieve positive outcomes in
                conflict situations, engaging manager or leadership as
                appropriate.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Actively listens and uses thoughtful questions to engage in
                dialogue that builds a shared understanding of concepts and
                ideas.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
            ...
            <tr>
              <td>
                ...
                Articulates thoughts and ideas using precise and straightforward
                language, appropriate tone and detail level while in alignment
                with audience needs.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
            ...
            <tr>
              <td>
                ...
                Converts ideas into properly written communications in alignment
                with audience needs, including relevant information, the right
                level of detail, and an appropriate tone.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Solicits and integrates input from others to improve work
                output.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
            ...
            <tr>
              <td>
                ...
                it; Learns from own mistake and the mistakes of others; Seeks
                peer and upward feedback with same zeal as from above.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
