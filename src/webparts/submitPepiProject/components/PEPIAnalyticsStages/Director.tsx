          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Guides the development of a well-reasoned, team POV by
                considering all information and perspectives; Is able to share
                with client effectively.
              </td>
            ...
            <tr>
              <td>
                ...
                Analyzes multiple points-of-views to highlight links,
                dependencies and impacts (qualitative and quantitative);
                quantifies impacts of various points-of-views to validate or
                disprove their validity and applicability.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Develops and implements straightforward operational plans;
                prioritizing, sequencing and estimating solution costs while
                considering interdependencies, risks and client situation and
                limitations; evaluates solution impact and value.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Frames the story using current information aligned to vetted
                hypotheses; Flags potential conflicts in the storyline and
                expands/revises hypotheses as additional facts are uncovered;
                Summarizes analyses and findings for each opportunity; and
                sequences implementation approaches effectively.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Defines analyses needed to prove or disprove hypotheses and is
                able to execute completely, accurately and on time; Draws
                actionable conclusions from analyses.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Decomposes problems into multiple issues to be addressed,
                develops fact-based conclusions to address issues, assimilating
                information from an array of relevant sources, and leveraging
                previous experience.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Takes accountability for both client and team identified issues,
                as well as the discovery of latent issues; Drives client and
                team to a sense of urgency relative to critical issues, and
                supports client in persevering on issue resolution, despite
                obstacles.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Listens and processes input and ideas from stakeholders and
                facilitates dialogue that enables stakeholders to hear, assess
                and integrate input to create co-authored solutions.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                deliverables, proposals, etc.); effectively summarizing
                information, balancing conciseness with appropriate level of
                detail, in alignment with audience needs. Coordinates team
                efforts to construct well-written formal documents.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
