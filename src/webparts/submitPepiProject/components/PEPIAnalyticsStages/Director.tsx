...
> {
  ...
  private getAverageCalculation(a, b, c, d, e) {
    ...
    let dCount = d > 0 ? 1 : 0;
    let eCount = e > 0 ? 1 : 0;
    return (a + b + c + d + e) / (aCount + bCount + cCount + dCount + eCount);
  }
  private resetNAValue(val): Promise<void> {
  ...
  private onChangeA1(newValue: string, TRValue: string): void {
    ...
    if (TRValue == "A11E") {
      ...
      this.setState({ A12E: Number(ctdNewValue) });
      ...
      this.setState({ A13E: Number(ctdNewValue) });
      ...
      this.setState({ A14E: Number(ctdNewValue) });
      ...
      this.setState({ A15E: Number(ctdNewValue) });
      ...
      this.setState({ A11R: Number(ctdNewValue) });
  ...
  private onChangeA2(newValue: string, TRValue: string): void {
    ...
    newValue = newValue === "NA" || newValue === "" ? "0" : newValue;
    if (TRValue == "A21E") {
      this.setState({ A21E: Number(ctdNewValue) });
      ...
      this.setState({ A22E: Number(ctdNewValue) });
      ...
      this.setState({ A23E: Number(ctdNewValue) });
      ...
      this.setState({ A24E: Number(ctdNewValue) });
  ...
  private onChangeA3(newValue: string, TRValue: string): void {
    ...
    newValue = newValue === "NA" || newValue === "" ? "0" : newValue;
    if (TRValue == "A31E") {
      this.setState({ A31E: Number(ctdNewValue) });
      ...
      this.setState({ A32E: Number(ctdNewValue) });
      ...
      this.setState({ A33E: Number(ctdNewValue) });
  ...
  private onChangeB1(newValue: string, TRValue: string): void {
    ...
    newValue = newValue === "NA" || newValue === "" ? "0" : newValue;
    if (TRValue == "B11E") {
      this.setState({ B11E: Number(ctdNewValue) });
      ...
      this.setState({ B12E: Number(ctdNewValue) });
  ...
  private onChangeB2(newValue: string, TRValue: string): void {
    ...
    newValue = newValue === "NA" || newValue === "" ? "0" : newValue;
    if (TRValue == "B21E") {
      this.setState({ B21E: Number(ctdNewValue) });
      let vallblB21D = Number(this.state.B21R) - Number(newValue);
      this.setState({ B21D: vallblB21D });
      AverageB2E = Number(
        parseFloat(
      ...
      this.setState({ B22E: Number(ctdNewValue) });
      let vallblB22D = Number(this.state.B22R) - Number(newValue);
      this.setState({ B22D: vallblB22D });
      AverageB2E = Number(
        parseFloat(
      ...
      this.setState({ B23E: Number(ctdNewValue) });
      let vallblB23D = Number(this.state.B23R) - Number(newValue);
      this.setState({ B23D: vallblB23D });
      AverageB2E = Number(
        parseFloat(
  ...
  private onChangeB3(newValue: string, TRValue: string): void {
    ...
    newValue = newValue === "NA" || newValue === "" ? "0" : newValue;
    if (TRValue == "B31E") {
      this.setState({ B31E: Number(ctdNewValue) });
      ...
      this.setState({ B32E: Number(ctdNewValue) });
      ...
      this.setState({ B33E: Number(ctdNewValue) });
  ...
  private onChangeB4(newValue: string, TRValue: string): void {
    ...
    newValue = newValue === "NA" || newValue === "" ? "0" : newValue;
    if (TRValue == "B41E") {
      this.setState({ B41E: Number(ctdNewValue) });
      ...
      this.setState({ B42E: Number(ctdNewValue) });
      ...
      this.setState({ B43E: Number(ctdNewValue) });
  ...
  private onChangeC1(newValue: string, TRValue: string): void {
    ...
    newValue = newValue === "NA" || newValue === "" ? "0" : newValue;
    if (TRValue == "C11E") {
      this.setState({ C11E: Number(ctdNewValue) });
      ...
      this.setState({ C12E: Number(ctdNewValue) });
      ...
      this.setState({ C13E: Number(ctdNewValue) });
  ...
  private onChangeC2(newValue: string, TRValue: string): void {
    ...
    newValue = newValue === "NA" || newValue === "" ? "0" : newValue;
    if (TRValue == "C21E") {
      this.setState({ C21E: Number(ctdNewValue) });
      ...
      this.setState({ C22E: Number(ctdNewValue) });
      ...
      this.setState({ C23E: Number(ctdNewValue) });
      ...
      this.setState({ C24E: Number(ctdNewValue) });
  ...
  private onChangeC3(newValue: string, TRValue: string): void {
    ...
    newValue = newValue === "NA" || newValue === "" ? "0" : newValue;
    if (TRValue == "C31E") {
      this.setState({ C31E: Number(ctdNewValue) });
      ...
      this.setState({ C32E: Number(ctdNewValue) });
      ...
      this.setState({ C33E: Number(ctdNewValue) });
