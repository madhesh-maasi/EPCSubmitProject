...
export default class SeniorDirector extends React.Component<
  IAnalyticsProps,
  IAnalyticsState
> {
  ...
  constructor(props: any) {
    ...
    this.state = {
      ...
      A1EE: !this.props.APEPIDetail.A1EE ? 0 : this.props.APEPIDetail.A1EE,
      A1RR: !this.props.APEPIDetail.A1RR ? 0 : this.props.APEPIDetail.A1RR,
      A1DD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.A1RR ? 0 : this.props.APEPIDetail.A1RR
            ) -
            Number(
              !this.props.APEPIDetail.A1EE ? 0 : this.props.APEPIDetail.A1EE
            )
          ).toString()
        ).toFixed(2)
      ),
      ...
      A2EE: !this.props.APEPIDetail.A2EE ? 0 : this.props.APEPIDetail.A2EE,
      A2RR: !this.props.APEPIDetail.A2RR ? 0 : this.props.APEPIDetail.A2RR,
      A2DD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.A2RR ? 0 : this.props.APEPIDetail.A2RR
            ) -
            Number(
              !this.props.APEPIDetail.A2EE ? 0 : this.props.APEPIDetail.A2EE
            )
          ).toString()
        ).toFixed(2)
      ),
      ...
      A3EE: !this.props.APEPIDetail.A3EE ? 0 : this.props.APEPIDetail.A3EE,
      A3RR: !this.props.APEPIDetail.A3RR ? 0 : this.props.APEPIDetail.A3RR,
      ...
      A3DD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.A3RR ? 0 : this.props.APEPIDetail.A3RR
            ) -
            Number(
              !this.props.APEPIDetail.A3EE ? 0 : this.props.APEPIDetail.A3EE
            )
          ).toString()
        ).toFixed(2)
      ),

      AAvgEE: !this.props.APEPIDetail.AAvgEE
        ? 0
        : this.props.APEPIDetail.AAvgEE,
      AAvgER: !this.props.APEPIDetail.AAvgER
        ? 0
      ...
      SctionTotalAD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.AAvgER ? 0 : this.props.APEPIDetail.AAvgER
            ) -
            Number(
              !this.props.APEPIDetail.AAvgEE ? 0 : this.props.APEPIDetail.AAvgEE
            )
          ).toString()
        ).toFixed(2)
      ),
      ...
      B1EE: !this.props.APEPIDetail.B1EE ? 0 : this.props.APEPIDetail.B1EE,
      B1RR: !this.props.APEPIDetail.B1RR ? 0 : this.props.APEPIDetail.B1RR,

      B1DD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.B1RR ? 0 : this.props.APEPIDetail.B1RR
            ) -
            Number(
              !this.props.APEPIDetail.B1EE ? 0 : this.props.APEPIDetail.B1EE
            )
          ).toString()
        ).toFixed(2)
      ),
      B2EE: !this.props.APEPIDetail.B2EE ? 0 : this.props.APEPIDetail.B2EE,
      B2RR: !this.props.APEPIDetail.B2RR ? 0 : this.props.APEPIDetail.B2RR,
      ...
      B2DD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.B2RR ? 0 : this.props.APEPIDetail.B2RR
            ) -
            Number(
              !this.props.APEPIDetail.B2EE ? 0 : this.props.APEPIDetail.B2EE
            )
          ).toString()
        ).toFixed(2)
      ),
      B3EE: !this.props.APEPIDetail.B3EE ? 0 : this.props.APEPIDetail.B3EE,
      B3RR: !this.props.APEPIDetail.B3RR ? 0 : this.props.APEPIDetail.B3RR,
      ...
      B3DD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.B3RR ? 0 : this.props.APEPIDetail.B3RR
            ) -
            Number(
              !this.props.APEPIDetail.B3EE ? 0 : this.props.APEPIDetail.B3EE
            )
          ).toString()
        ).toFixed(2)
      ),

      B4EE: !this.props.APEPIDetail.B4EE ? 0 : this.props.APEPIDetail.B4EE,
      B4RR: !this.props.APEPIDetail.B4RR ? 0 : this.props.APEPIDetail.B4RR,
      ...
      B4DD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.B4RR ? 0 : this.props.APEPIDetail.B4RR
            ) -
            Number(
              !this.props.APEPIDetail.B4EE ? 0 : this.props.APEPIDetail.B4EE
            )
          ).toString()
        ).toFixed(2)
      ),
      ...
      BAvgEE: !this.props.APEPIDetail.BAvgEE
        ? 0
        : this.props.APEPIDetail.BAvgEE,
      BAvgER: !this.props.APEPIDetail.BAvgER
        ? 0
      ...
      SctionTotalBD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.BAvgER ? 0 : this.props.APEPIDetail.BAvgER
            ) -
            Number(
              !this.props.APEPIDetail.BAvgEE ? 0 : this.props.APEPIDetail.BAvgEE
            )
          ).toString()
        ).toFixed(2)
      ),
      ...
      CAvgEE: !this.props.APEPIDetail.CAvgEE
        ? 0
        : this.props.APEPIDetail.CAvgEE,
      CAvgER: !this.props.APEPIDetail.CAvgER
        ? 0
      ...
      SctionTotalCD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.CAvgER ? 0 : this.props.APEPIDetail.CAvgER
            ) -
            Number(
              !this.props.APEPIDetail.CAvgEE ? 0 : this.props.APEPIDetail.CAvgEE
            )
          ).toString()
        ).toFixed(2)
      ),

      C1EE: !this.props.APEPIDetail.C1EE ? 0 : this.props.APEPIDetail.C1EE,
      C1RR: !this.props.APEPIDetail.C1RR ? 0 : this.props.APEPIDetail.C1RR,
      C2EE: !this.props.APEPIDetail.C2EE ? 0 : this.props.APEPIDetail.C2EE,
      C2RR: !this.props.APEPIDetail.C2RR ? 0 : this.props.APEPIDetail.C2RR,
      C3EE: !this.props.APEPIDetail.C3EE ? 0 : this.props.APEPIDetail.C3EE,
      C3RR: !this.props.APEPIDetail.C3RR ? 0 : this.props.APEPIDetail.C3RR,
      C1DD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.C1RR ? 0 : this.props.APEPIDetail.C1RR
            ) -
            Number(
              !this.props.APEPIDetail.C1EE ? 0 : this.props.APEPIDetail.C1EE
            )
          ).toString()
        ).toFixed(2)
      ),
      C2DD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.C2RR ? 0 : this.props.APEPIDetail.C2RR
            ) -
            Number(
              !this.props.APEPIDetail.C2EE ? 0 : this.props.APEPIDetail.C2EE
            )
          ).toString()
        ).toFixed(2)
      ),
      C3DD: Number(
        parseFloat(
          (
            Number(
              !this.props.APEPIDetail.C3RR ? 0 : this.props.APEPIDetail.C3RR
            ) -
            Number(
              !this.props.APEPIDetail.C3EE ? 0 : this.props.APEPIDetail.C3EE
            )
          ).toString()
        ).toFixed(2)
      ),
    ...
    if (
      ...
      this.props.APEPIDetail.Reviewee.Email == this.props.loggeduseremail &&
        ...
        this.setState({
          ...
          SctionTotalDR: 0,
          SctionTotalDD: Number(
            parseFloat(Number(0 - this.props.SctionTotalDE).toString()).toFixed(
              2
            )
          ),
          OverallCoreR: 0,
  ...
  private isValidLeadMD(): boolean {
    ...
    let valid: boolean = false;
    if (this.props.APEPIDetail.H1EL) {
      valid = true;
    }
    return valid;
  }
      ...
      <div>
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Drives the development of a well-reasoned, client relevant, team
                POV, appropriately leverages others' POVs; develops complex POVs
                or multiple POVs concurrently, for different issues.
              </td>
            ...
            <tr>
              <td>
                ...
                Collaborates with the client to identify and resolve all stated
                and unstated issues and conflicts, and create a unifying
                point-of-view that moves the client forward.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Develops comprehensive and concise storyboards that articulate
                the situation, problem, recommended approach, benefits, and
                risks and mitigations; Resolves potential storyline conflicts
                and refines the story as additional facts, evidence and
                assumptions are discovered, engaging client appropriately.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Connects with client to facilitate information gathering
                activities and identify and pursue all possible data sources to
                insure relevant data is collected and considered (external and
                internal)
              </td>
              <td className={styles.doppadding}>
                <Dropdown
            ...
            <tr>
              <td>
                ...
                Challenges analyses and conclusions to ensure that they are
                accurate, evidence-based and reflective of the situation;
                Identifies holes in analyses that lead to a disconnect between
                solution recommendations and results.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
        ...
        <div className={styles.sectionContent}>
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                <label className={styles.tablelable}> Preparation - </label>{" "}
                Dedicates time to understanding client environment, client team
                motivations, and concern; Before engaging the client, ensures
                team is prepared and properly organized.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
        ...
        <div className={styles.sectionContent}>
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                <label className={styles.tablelable}>A&M Values - </label>{" "}
                Adopts A&M values as guiding principles that direct behavior,
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Models feedback and performance management and holds direct
                reports accountable for providing timely, objective, direct,
                constructive and actionable feedback on-the-job and within the
                context of the PEPI performance process.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Advocates and enables PEPI training and development activities
                as scheduled; Emphasizes mentorship within PEPI to accelerate
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Provides objective and effective coaching and counsel to client
                team members on key business issues, driving the team to achieve
                intended business outcomes, earning the title of a trusted
                business advisor.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Deliberately builds relationships (across PEPI, Big A&M, Private
                Equity and Portfolio Companies) and cultivates them into
                longer-term business relationships; Engages clients outside
            ...
            <tr>
              <td>
                ...
                Leads selling and engagement expansion efforts with new and
                existing clients; Identifies opportunities to engage both PEPI
                and broader A&M services at an existing or prospective client.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                communication styles, and recruits team members that align to
                the client context to drive team success; Actively assists in
                making project staffing decisions.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Selects the right leadership style, based on the sitation, as
                well as the capabilities, motivations and commitment level to
                drive PEPI and client team performance
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Facilitates complex executive meetings to drive to intended
                outcomes, preparing and leveraging others appropriately and
                asking tough questions to push the group; Knows when and how to
                engage or cede the floor to drive to outcomes within time
                constraints.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
            ...
            <tr>
              <td>
                ...
                Navigates and/or drives conversation shifts appropriately,
                reading audience and adjusting messaging, tone, focus,
                non-verbals and discussion duration as audience responds and/or
                situation evolves.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
            ...
            <tr>
              <td>
                ...
                Converts ideas into well-written, formal communications (e.g.
                SOW, work plans) in alignment with audience needs; Uses written
                communication to crystalize ideas, build consensus and
                influence.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                individually and as a team lead; Seeks and provides counsel and
                is willing to experiment to improve and/or find solutions.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
