          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Organizes and processes relevant data and information to support
                the development of a fact-based, team POV.
              </td>
            ...
            <tr>
              <td>
                ...
                Identifies problems and knows when and how to raise a flag.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Sets up tools and is able to access client data in support of
                information gathering activities. Able to plan and execute
                research and other external data gathering processes.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Researches and understands context before engaging clients.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                with defined workplans considering review schedules, and manages
                and/or escalates questions on a timely basis.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                and problems, and perseveres when dealing with challenges and
                setbacks.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                relevant, thoughtful and well-formed questions.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
