...
> {
  ...
  constructor(props: any) {
    ...
    // this.onPERFORMANCEDISCUSSIONApproved =
    //   this.onPERFORMANCEDISCUSSIONApproved.bind(this);
  ...
  public async componentDidMount() {
    ...
    // else if (
    //   this.props.APEPIDetail.StatusOfReview ==
    //     Config.StatusOfReview.AwaitingPerformanceDiscussion &&
    //   (this.props.APEPIDetail.Reviewer.Email == this.props.loggeduseremail ||
    //     this.props.isAdmin)
    // ) {
    //   this.setState({ IsPerformanceDiscussion: false });
    // }
    else if (
      this.props.APEPIDetail.StatusOfReview ==
  ...
  /* Deva changes start */
  // private async onPERFORMANCEDISCUSSIONApproved(): Promise<void> {
  //   const pepiDetails = this.state.ApepiDetails;
  //   let data = {};
  //   const columns = Config.PEPIProjectsListColumns;
  //   data[columns.StatusOfReview] =
  ...
  //     let valA11ED =
  //       (Number(vallblA11D) +
  //         Number(this.state.A12D) +
  //         Number(this.state.A13D) +
  //         Number(this.state.A14D) +
  //         Number(this.state.A15D)) /
  //       5;
  //     this.setState({ A1DD: valA11ED });
  //     //this.setState({this.state.ApepiDetails.A1EE :valA11ED });
  //     //this.props.onFormFieldValueChange(newValue);
  ...
  //     let valA21ED =
  //       (Number(vallblA21D) +
  //         Number(this.state.A22D) +
  //         Number(this.state.A23D) +
  //         Number(this.state.A24D)) /
  //       4;
  ...
  //     let valA31ED =
  //       (Number(vallblA31D) +
  //         Number(this.state.A32D) +
  //         Number(this.state.A33D)) /
  //       3;
  ...
  //     let valB31ED =
  //       (Number(vallblB31D) +
  //         Number(this.state.B32D) +
  //         Number(this.state.B33D)) /
  //       3;
  ...
  //     let valB41ED =
  //       (Number(vallblB41D) +
  //         Number(this.state.B42D) +
  //         Number(this.state.B43D)) /
  //       3;
  ...
  //     let valC11ED =
  //       (Number(vallblC11D) +
  //         Number(this.state.C12D) +
  //         Number(this.state.C13D)) /
  //       3;
  ...
  //     let valC21ED =
  //       (Number(vallblC21D) +
  //         Number(this.state.C22D) +
  //         Number(this.state.C23D) +
  //         Number(this.state.C24D)) /
  //       4;
  ...
  //     let valC31ED =
  //       (Number(vallblC31D) +
  //         Number(this.state.C32D) +
  //         Number(this.state.C33D)) /
  //       3;
  ...
  private onChangeE1EE(
    event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>,
    newValue: string
  ): void {
    //this.setState({ E1EE: newValue,});
    let curretState = this.state.ApepiDetails;
    curretState.E1EE = newValue;
    this.onFormTextFieldValueChange(curretState);
  }
  private onChangeE1ER(
    event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>,
    newValue: string
  ): void {
    //this.setState({ E1ER: newValue,});
    let curretState = this.state.ApepiDetails;
    curretState.E1ER = newValue;
    this.onFormTextFieldValueChange(curretState);
  }
  private onChangeF1EE(
    event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>,
    newValue: string
  ): void {
    //this.setState({ F1EE: newValue,});
    let curretState = this.state.ApepiDetails;
    curretState.F1EE = newValue;
    this.onFormTextFieldValueChange(curretState);
  }
  private onChangeF1ER(
    event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>,
    newValue: string
  ): void {
    //this.setState({ F1ER: newValue,});
    let curretState = this.state.ApepiDetails;
    curretState.F1ER = newValue;
    this.onFormTextFieldValueChange(curretState);
  }
  private onChangeG1EE(
    event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>,
    newValue: string
  ): void {
    //this.setState({ G1EE: newValue,});
    let curretState = this.state.ApepiDetails;
    curretState.G1EE = newValue;
    this.onFormTextFieldValueChange(curretState);
  }
  private onChangeG1ER(
    event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>,
    newValue: string
  ): void {
    //this.setState({ G1ER: newValue,});
    let curretState = this.state.ApepiDetails;
    curretState.G1ER = newValue;
    this.onFormTextFieldValueChange(curretState);
  }
  private onChangeH1EE(
    event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>,
    newValue: string
  ): void {
    //this.setState({ H1EE: newValue,});
    let curretState = this.state.ApepiDetails;
    curretState.H1EE = newValue;
    this.onFormTextFieldValueChange(curretState);
  }
  private onChangeH1ER(
    event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>,
    newValue: string
  ): void {
    //this.setState({ H1ER: newValue,});
    let curretState = this.state.ApepiDetails;
    curretState.H1ER = newValue;
    this.onFormTextFieldValueChange(curretState);
  }
  ...
  // private isValidPerformanceDiscussion(): boolean {
  //   let ApepiQuestionText = this.state.ApepiQuestionText;
  //   let sectionD = ApepiQuestionText.filter(
  //     (item) =>
  //       (item.Reviewee == "" || Number(item.Reviewee) == 0) &&
  ...
  //   );
  //   let valid: boolean = false;
  //   if (this.state.ApepiDetails.PerformanceDiscussion) {
  //     valid = true;
  //   }
  //   return valid;
  // }
      ...
      <div className={styles.sectionContent}>
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Processes data and information with direction to support the
                development of a fact-based, team POV.
              </td>
            ...
            <tr>
              <td>
                ...
                Identifies flaws and conflicting points-of-view when assessing
                and analyzing basic facts and assumptions.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Executes operational tasks independently and identifies when
            ...
            <tr>
              <td>
                ...
                Identifies problems and knows when to raise a flag.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Applies A&M templates and standards to develop assigned slides
                that are accurate and in alignment with the storylines.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Knows where and how to access the right data for the assignment.
                Able to execute research and other external data gathering
                processes.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Researches and understands context before engaging others.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                with defined workplan considering review schedules, and
                escalates questions on a timely basis.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Acts with a sense of urgency to resolve client and team issues
                and problems.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Participates in activities that build the PEPI team and its
                capabilities; Leverages PEPI best practices and methodologies.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Demonstrates awareness of one's own communication and learning
                styles, as well as one's own emotional state, recognizing how
                these impact interactions with others.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Engages manager and / or leadership in a timely manner to assist
                in managing and resolving conflict situations.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Demonstrates active listening by paraphrasing and asking
                relevant questions.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
            ...
            <tr>
              <td>
                ...
                Organizes information into properly written communications that
                include relevant information, the right level of detail, and an
                appropriate tone.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
          ...
          <table className={styles.tableWithoutboder}>
            ...
            <tr>
              <td>
                ...
                Proactively seeks feedback and direction on opportunities to
                professionally develop capabilities and skill sets.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
            ...
            <tr>
              <td>
                ...
                Embraces unfamiliar tasks and responsibilities, and solicits
                input from others to improve work output.
              </td>
              <td className={styles.doppadding}>
                <Dropdown
                  disabled={this.state.IsReviewee}
          ...
          <div className={styles.sectionContent}>
            <table className={styles.tableWithoutboder}>
              ...
              <tr>
                ...
                <td>
                  {" "}
                  <label> {this.state.SctionTotalDE}</label>
                </td>
                <td>
                  {" "}
                  <label>
              ...
              {this.props.APEPIDetail.StatusOfReview !=
                ...
                <tr>
                  ...
                  <td>
                    {" "}
                    <label> {this.state.SctionTotalDR}</label>
                  </td>
                  <td>
                    {" "}
                    <label>
        ...
        {this.state.ApepiDetails.StatusOfReview !=
          ...
          >
            ...
            {/* <div className={styles.row}><Label><b>REVIEWEE: </b> When you have finished reviewing the performance appraisal, complete the section below and click Submit Final Review. </Label></div>
   <div className={styles.row}><Label><b>REVIEWEE ACKNOWLEDGEMENT COMMENTS </b> (Comments are optional and visible to the Reviewer and Lead MD.)</Label></div> */}
        ...
        {/* {(!this.state.IsReviewee) &&
            <div className={styles.sectionContent}>
              ...
              <div className={styles.col25left}><PrimaryButton text="SAVE DRAFT" onClick={this.onREVIEWEESaveDRAFT} ></PrimaryButton></div>
              <div className={styles.col25left}><PrimaryButton text="SUBMIT TO REVIEWER FOR APPROVAL " onClick={this.onREVIEWEEApproved} ></PrimaryButton></div>
              <div className={styles.col25left}><Label><b>When you have chosen all the drop-down fields and completed all text areas the Submit button will turn green and be enabled.</b></Label> </div>
            </div>
          }
          {(!this.state.IsReviewer) &&
            <div className={styles.sectionContent}>
              ...
              <div className={styles.col25left}><PrimaryButton text="SAVE DRAFT" onClick={this.onREVIEWERSaveDRAFT} ></PrimaryButton></div>
              <div className={styles.col25left}><PrimaryButton text="SUBMIT TO LEAD MD FOR APPROVAL " onClick={this.onREVIEWERApproved} ></PrimaryButton></div>
              <div className={styles.col25left}><Label><b>When you have chosen all the drop-down fields, completed all text areas, selected an Overall Performance Rating and held a Reviewee discussion the Submit button will turn green and be enabled.</b></Label> </div>
              <div className={styles.row}>
                <Label> Optional Reversion Comment (visible)</Label><TextField resizable={false} multiline={false} value={this.state.ApepiDetails.H1EE} onChange={this.onChangeH1EE} className={styles.Multilinetextarea}></TextField>
                <PrimaryButton text="REVERT TO REVIWEE" onClick={this.onREVERTTOREVIEEE}> </PrimaryButton> </div>
            </div>
          }
          {(!this.state.IsLeadMD) &&
            <div className={styles.sectionContent}>
              ...
              <div className={styles.col25left}><PrimaryButton text="SUBMIT TO REVIEWEE FOR ACKNOWLEDGEMENT " onClick={this.onLEADMDApproved} ></PrimaryButton></div>
              <div className={styles.row}><Label> Optional Reversion Comment (visible)</Label><TextField resizable={false} multiline={false} value={this.state.ApepiDetails.H1EE} onChange={this.onChangeH1EE} className={styles.Multilinetextarea}></TextField> <PrimaryButton text="REVERT TO REVIEER" onClick={this.onREVERTTOREVIEER}> </PrimaryButton> </div>
            </div>
          }
          {(!this.state.IsAcknowledgement) &&
            <div className={styles.sectionContent}>
              ...
              <div className={styles.row}><Label><b>REVIEWEE ACKNOWLEDGEMENT COMMENTS: </b>(Comments are optional and visible to the Reviewer and Lead MD.)</Label></div>
              <div><fieldset> <legend></legend> <textarea className={styles.Multilinetextarea} onClick={this.onChangeAcknowledgement} value={this.state.ApepiDetails.AcknowledgementComments}></textarea></fieldset></div>
              <div className={styles.col25left}><PrimaryButton text="SAVE DRAFT" onClick={this.onFinalSAVEDRAFT} ></PrimaryButton></div>
              <div className={styles.col25left}><PrimaryButton text="SUBMIT TO FINAL REVIEW " onClick={this.onSUBMITTOFINALREVIEW} ></PrimaryButton></div>
            </div>
          }
          ...
          {(this.state.IsReviewee) &&
            <div className={styles.sectionContent}>
              <fieldset> <legend>Signoff History</legend> <textarea disabled={true} value={this.state.ApepiDetails.SignoffHistory} className={styles.Multilinetextarea}></textarea></fieldset>
            </div>
          } */}
              ...
              {this.props.hasEditItemPermission && (
                ...
                >
                  <PrimaryButton
                    ...
                    // text="SUBMIT TO AWAITING PERFORMANCE DISCUSSION"
        ...
        {/* Deva changes start */}
        {/* {!this.state.IsPerformanceDiscussion && (
          <div className={styles.row}>
            <div className={styles.divbtnREVIEWEEFORAcknowledgment}>
              {this.props.hasEditItemPermission && (
                <div
                ...
                >
                  <PrimaryButton
                    disabled={!this.isValidPerformanceDiscussion()}
                    className={
                      this.isValidPerformanceDiscussion()
                        ? styles.btnApproved
                        : styles.btnDisable
                    }
                    text="SUBMIT TO REVIEWEE FOR ACKNOWLEDGEMENT"
                    onClick={this.onPERFORMANCEDISCUSSIONApproved}
                  />
                </div>
              )}
            </div>
